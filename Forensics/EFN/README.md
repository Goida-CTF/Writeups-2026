...
Прочитав [некоторые статейки](https://www.opennet.ru/tips/3025_wpa_wpa2_wifi_aircrackng_hashcat.shtml) и подтянув матчасть возвращаемся к задачке - устанавливаем `hcxpcapngtool`, достаем брутабельный хэш и отправляем его брутиться в `hashcat` (зная, что у роутеров TP-Link стандартный пароль - 8 цифр):
...
<img width="1102" height="601" alt="creds-wireshark" src="https://github.com/user-attachments/assets/8fe44eff-e301-44b2-8c6b-6593649e3626" />
...
*В целом, можно было полностью вытащить текст из pdf-файла и погрепать флаг. Но это больше для тех, кто не шарит за сикссевен или не умеет видеть банальные подсказки.*
